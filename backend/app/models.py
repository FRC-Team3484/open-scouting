...
class Settings(Model):
    ...
    # Settings:
    #    Human readable names come from the field key. Ex: favorite_events -> Favorite Events
    favorite_events = fields.JSONField(null=True, default=list, description="The list of favorite events for the user")
