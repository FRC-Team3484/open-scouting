...
register_tortoise(
    app,
    db_url=os.getenv("DATABASE_URL", "postgres://devuser:devpassword@localhost:5432/devdb"),
...
TORTOISE_ORM = {
    "connections": {"default": os.getenv("DATABASE_URL", "postgres://devuser:devpassword@localhost:5432/devdb")},
    "apps": {
        "models": {
