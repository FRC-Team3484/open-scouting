...
from ..models import MatchScoutingAnswer, MatchScoutingSubmission, Passkey, PitScoutingAnswer, User, Profile, Settings, Session, VerificationCode
from .emails import send_password_change_notification, send_verification_code
from ..schemas.generic import MessageResponse
from ..schemas.auth import BaseSettings, ChangeEmailRequest, ChangePasswordRequest, DeleteAccountRequest, ForgotPasswordRequest, SignupRequest, UserMeResponse, UserResponse, UserSetting, VerifyVerificationCodeRequest, VerifyVerificationCodeResponse
...
@router.delete("/auth/me/delete_account", response_model=MessageResponse)
async def delete_account(data: DeleteAccountRequest, identity: Identity = Depends(require_user)):
    """
