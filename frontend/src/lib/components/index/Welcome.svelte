...
-->
<script lang="ts">
    import { GithubLogoIcon, BugIcon, RocketIcon, ArrowRightIcon, DiscordLogoIcon, DatabaseIcon } from "phosphor-svelte";
...
<div class="flex flex-col gap-4 items-center mb-8">
    ...
    <Button href="/data" variant="outline"><DatabaseIcon weight="bold" /> View Data</Button>
</div>