...
export const getAllPitsPitsGetGet = async ( options?: RequestInit): Promise<getAllPitsPitsGetGetResponse> => {
...
export const deletePitPitsDeletePitUuidDelete = async (pitUuid: string, options?: RequestInit): Promise<deletePitPitsDeletePitUuidDeleteResponse> => {
