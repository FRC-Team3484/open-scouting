 ...
 * @summary Delete User
 */
export const DeleteUserUsersDeleteUsernameDeleteParams = zod.object({
  "username": zod.string()
})

export const DeleteUserUsersDeleteUsernameDeleteResponse = zod.object({
  "message": zod.string()
})
 ...
 */
export const SetSuperuserUsersSetSuperuserUsernamePostParams = zod.object({
  "username": zod.string()
})

export const SetSuperuserUsersSetSuperuserUsernamePostResponse = zod.object({
  "uuid": zod.string().uuid(),
  "username": zod.string(),
  "email": zod.string().email(),
  "is_superuser": zod.boolean(),
