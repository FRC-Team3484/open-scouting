...
export const GetDataDataGetGetResponseItem = zod.object({
  ...
  "value": zod.union([zod.string(),zod.boolean(),zod.int(),zod.number(),zod.null()])
})),
  "min": zod.number(),
  "max": zod.number(),
  "avg": zod.number()
  ...
  "field_type": zod.string(),
  "field_name": zod.string(),
  "values": zod.array(zod.union([zod.string(),zod.boolean(),zod.int(),zod.number(),zod.null()])),
  ...
  "values": zod.union([zod.array(zod.union([zod.int(),zod.number()])),zod.record(zod.string(), zod.number())])
}))
})
