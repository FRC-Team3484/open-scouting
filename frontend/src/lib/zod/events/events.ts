 ...
 */
export const GetEventInfoEventInfoYearEventCodeGetParams = zod.object({
  "year": zod.int(),
  "event_code": zod.string()
})

export const GetEventInfoEventInfoYearEventCodeGetResponse = zod.object({
  "match_scouting_submissions": zod.int(),
  "match_scouting_answers": zod.int(),
  "pits": zod.int(),
  "pit_answers": zod.int(),
  "pits_complete": zod.int(),
  "pits_incomplete": zod.int(),
  "pits_not_started": zod.int()
})
