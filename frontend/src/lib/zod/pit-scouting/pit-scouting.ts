...
export const CreatePitFieldPitsFieldsSeasonUuidCreatePostBody = zod.object({
  "uuid": zod.union([zod.uuid(),zod.null()]).optional(),
  "season_uuid": zod.uuid(),
  "name": zod.string(),
  "description": zod.union([zod.string(),zod.null()]),
  "required": zod.boolean(),
  ...
  "order": zod.int(),
  "organization_uuid": zod.union([zod.uuid(),zod.null()]).optional()
})
 ...
 * @summary Get Pits
 */
export const GetPitsPitsGetSeasonUuidEventCodePostParams = zod.object({
  "season_uuid": zod.uuid(),
  "event_code": zod.string()
})

export const GetPitsPitsGetSeasonUuidEventCodePostResponseItem = zod.object({
  "uuid": zod.uuid(),
  "team_number": zod.int(),
  "nickname": zod.string(),
  "created_at": zod.iso.datetime({"offset":true}),
  ...
  "uuid": zod.uuid(),
  "field_uuid": zod.uuid(),
  "value": zod.union([zod.string(),zod.boolean(),zod.int(),zod.number()]),
  "username": zod.string(),
  "created_at": zod.iso.datetime({"offset":true})
}))
})
export const GetPitsPitsGetSeasonUuidEventCodePostResponse = zod.array(GetPitsPitsGetSeasonUuidEventCodePostResponseItem)
