...
export const GetSeasonFieldsFieldsSeasonSeasonUuidGetResponseItem = zod.object({
  "uuid": zod.uuid(),
  "name": zod.string(),
...
export const CreateSeasonFieldFieldsSeasonSeasonUuidCreatePostBody = zod.object({
  ...
  "parent_uuid": zod.union([zod.uuid(),zod.null()]).optional(),
  "options": zod.object({
  "choices": zod.array(zod.unknown()),
  "default": zod.number(),
  "minimum": zod.number(),
...
export const MoveMatchScoutingFieldsFieldsSeasonUuidReorderPatchBodyItem = zod.object({
  "uuid": zod.uuid(),
  "order": zod.int(),
  "parent_uuid": zod.union([zod.uuid(),zod.null()])
})
