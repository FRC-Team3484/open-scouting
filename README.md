<div align="center">
  ...
  **[Live Server](https://open-scouting-legacy.nfoert.dev/) ● [Releases](https://github.com/FRC-Team3484/open-scouting/releases) ● [Issues](https://github.com/FRC-Team3484/open-scouting/issues) ● [Development branch](https://github.com/FRC-Team3484/open-scouting/tree/development) ● [API Docs](https://open-scouting-legacy.nfoert.dev/api)**
</div>
...
## Read API
API schema information are auto generated and available [here](https://open-scouting-legacy.nfoert.dev/api). 
...
You can create an API Key upon creating an account on the server, navigating to the [profile page](https://open-scouting-legacy.nfoert.dev/profile), and clicking on the `API Keys` section.